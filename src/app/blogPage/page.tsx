  ...
  return (
    <div>
      ...
      <div className="ml-20 flex gap-24 mb-10">
        <div>
          <img src="/bruce-mars-FWVMhUa_wbY-unsplash 2.png" alt=""  className="mt-10"/>
          ...
          <img src="/bruce-mars-FWVMhUa_wbY-unsplash 3.png" alt="" className="mt-10" />
          <img src="/Group 164.png" alt="" className="mt-10" />
          ...
          <button className="text-blue-950 font-semibold text-[18px] mt-5 underline" >Read More</button>
          <img src="/bruce-mars-FWVMhUa_wbY-unsplash 4.png" alt="" className="mt-10" />
          <img src="/Group 164.png" alt="" className="mt-10" />
        ...
        <div>
            ...
            <li> <img src="/Group 202.png" alt=""  className="w-[25px]" /></li>
            <li> <img src="/Group 203.png" alt=""  className="w-[25px]"/></li>
            <li> <img src="/Group 204.png" alt=""  className="w-[25px]"/></li>
            </ul>
