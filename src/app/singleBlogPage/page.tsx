  ...
  return (
    <div>
      <div className="bg-bag h-[286px] w-[1920px]">
        <h1 className="text-[40px] text-blue-950  font-bold pt-[125px] ml-52">
          Single Blog Page
        </h1>
      </div>
      <div>
      ...
      <div className="ml-20 flex gap-5 mb-10">
        <div>
          ...
          <p className="text-para2 mt-4">
            ...
            <br /> eu malesuada vitae ultrices in in neque, porta dignissim.
          ...
          <p className="text-para2 text-[16px] mt-14">
            ...
            <br /> adipiscing elit. Velit dapibus est, nunc, montes, lacus
            consequat integer viverra. Sit morbi etiam quam rhoncus. Velit in
            arcu
            <br /> platea donec vitae ante posuere malesuada.Lorem ipsum dolor
            sit amet, consectetur adipiscing elit. Velit dapibus est, nunc,
          </p>
          <p className="text-para2 italic text-[16px] mt-10 py-5 border-l-2 px-3 h-[121px]  border-pink-500">
        ...
        <div>
          <h1 className="text-blue-950 text-[25px] font-semibold mt-9">
            Search
          </h1>
          <input
            type="text"
            placeholder="Search for post"
            className="py-3 mt-2 px-3 w-[310px] border-2 rounded-md"
          />
          <h1 className="text-blue-950 text-[25px] font-semibold mt-8">
            Categories
          </h1>
          <ul className="grid grid-cols-2 gap-4 mt-2">
            <li className="text-blue-950 w-[132px] border  py-2 px-2 rounded-sm hover:bg-pink-500 cursor-pointer  ">
              Hobbies(41)
            </li>
            <li className="text-blue-950 w-[132px] border py-2 px-2  rounded-sm hover:bg-pink-500 cursor-pointer ">
              Women(21)
